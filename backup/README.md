...
- **Include terminal screen** — tick this before sending, and whatever is currently
  visible in the terminal is attached to your question. Good for "why did this
  fail?".
...
**Mouse (both panes):** drag to select, then **right-click to copy** it. With
